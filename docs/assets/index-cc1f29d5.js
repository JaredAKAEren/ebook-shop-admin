...
`,[B("bordered",[O("border",`
 ...
 overflow: hidden;
 padding: 0;
 `,[nn({duration:".2s"})])]),_("menu-item-group",[_("menu-item-group-title",`
 margin-top: 6px;
 color: var(--n-group-text-color);
 cursor: default;
 font-size: .93em;
