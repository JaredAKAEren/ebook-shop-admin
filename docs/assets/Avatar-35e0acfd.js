import{i as F,e as _,o as A}from"./Dropdown-c9571bf6.js";import{a as K,b as P,f as V,g as $,ag as G,o as T,ah as D,n as w,d as U,j as X,r as x,l as R,u as M,ai as Y,m as q,K as J,H as Q,aj as Z,ak as ee,al as oe,h as L,x as B,am as re,an as te,ao as ne}from"./index-150cb9dd.js";const ae=r=>{const{borderRadius:d,avatarColor:s,cardColor:a,fontSize:c,heightTiny:f,heightSmall:l,heightMedium:p,heightLarge:v,heightHuge:h,modalColor:g,popoverColor:u}=r;return{borderRadius:d,fontSize:c,border:`2px solid ${a}`,heightTiny:f,heightSmall:l,heightMedium:p,heightLarge:v,heightHuge:h,color:P(a,s),colorModal:P(g,s),colorPopover:P(u,s)}},ie={name:"Avatar",common:K,self:ae},se=ie,le=V("n-avatar-group"),de=$("avatar",`
